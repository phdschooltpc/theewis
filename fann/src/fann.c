...
#pragma PERSISTENT(neuron_its)
#pragma PERSISTENT(last_neurons)
#pragma PERSISTENT(neuronss)
#pragma PERSISTENT(neuron_pointerss)
#pragma PERSISTENT(is)
#pragma PERSISTENT(num_connectionss)
#pragma PERSISTENT(num_inputs)
#pragma PERSISTENT(num_outputs)
#pragma PERSISTENT(neuron_sums)
#pragma PERSISTENT(outputs)
#pragma PERSISTENT(weightss)
#pragma PERSISTENT(layer_its)
#pragma PERSISTENT(last_layers)
#pragma PERSISTENT(activation_functions)
#pragma PERSISTENT(steepnesss)
#pragma PERSISTENT(first_neurons)

struct fann_neuron neuron_its = {0}, last_neurons = {0}, neuronss = {0}, **neuron_pointerss= {0};
unsigned int is=0, num_connectionss=0, num_inputs=0, num_outputs = 0;
fann_type neuron_sums = 0, outputs= 0;
fann_type weightss= {0};
struct fann_layer layer_its = {0}, last_layers= {0};
unsigned int activation_functions = 0;
fann_type steepnesss= 0;
struct fann_neuron first_neurons = {0};

FANN_EXTERNAL __inline fann_type *FANN_API fann_run(struct fann *ann, fann_type * input)
{
    ...
    neuron_it = &neuron_its;
    last_neuron = &last_neurons;
    neurons = &neuronss;
    neuron_pointers = neuron_pointerss;
    i = is;
    num_connections = num_connectionss;
    num_input = num_inputs;
    num_output = num_outputs;
    neuron_sum = &neuron_sums;
    output = (fann_type*)&outputs;
    weights = &weightss;
    layer_it = &layer_its;
    last_layer = &last_layers;
    activation_function = activation_functions;
    steepness = &steepnesss;
